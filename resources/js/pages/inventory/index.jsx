...
export default function Index({ balances, warehouses, filters, summary }) {
    ...
    const hasFilters = Boolean(
        filters.search || filters.warehouseId || filters.lowStock,
    );
    const submit = (event) => {
    ...
    return (
        <>
            ...
            <div className="nexa-page">
                <PageHeader
                    title="Inventory"
                    description="Monitor warehouse stock, reorder exposure and inventory value."
                >
                ...
                <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    ...
                    <StatCard
                        label="Stock value"
                        value={money(summary.stock_value)}
                        detail="Based on recorded cost"
                    ...
                    <StatCard
                        ...
                        icon={AlertTriangle}
                        tone={summary.low_stock ? 'warning' : 'success'}
                    />
                </div>

                <form
                    onSubmit={submit}
                    className="nexa-card flex flex-col gap-3 p-3 lg:flex-row lg:items-center"
                >
                ...
                <DataPanel
                    ...
                    description="Current quantities by product and warehouse"
                            ...
                            <tbody>
                                {!balances.data.length && (
                                    <EmptyTable
                                        ...
                                        description={
                                            hasFilters
                                                ? 'Adjust the warehouse, stock or search filters.'
                                                : 'Use an opening-stock adjustment to introduce inventory.'
                                        }
                                        href={
                                            !hasFilters
                                ...
                                {balances.data.flatMap((product) => {
                                    const productBalances = product
                                        .inventory_balances.length
