        ...
        <>
            ...
            <div className="nexa-page">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    <Heading
                        title="Business"
                        description="Company identity, registration and invoice defaults."
                    />
                    <Button asChild>
                    ...
                    <div className="flex flex-col gap-5 p-6 sm:flex-row sm:items-center">
                        ...
                        <div className="min-w-0 flex-1">
                            ...
                            <p className="mt-1 text-sm text-muted-foreground">
                                NexaERP business account
                            </p>
                        </div>
                        <div className="flex items-center gap-2 rounded-lg bg-amber-50 px-3 py-2 text-xs font-medium text-amber-700 dark:bg-amber-950/40 dark:text-amber-400">
                            <span className="size-1.5 rounded-full bg-amber-500" />
                            NRS compliance in development
                        </div>
                    </div>
                </section>
                ...
                <div className="grid items-start gap-5 lg:grid-cols-2">
                    <section className="nexa-card">
                        <SectionHeader
                            ...
                            copy="Legal and contact information"
                        />
                    ...
                    <section className="nexa-card">
                        <SectionHeader
                            ...
                            copy="Primary business location"
                        />
                        <dl className="divide-y px-5">
                            <Row
                                label="Address"
                ...
                <section className="nexa-card">
                    <SectionHeader
                        ...
                        copy="Defaults used across documents and reports"
                    />
                    <dl className="px-5">
                        <Row
