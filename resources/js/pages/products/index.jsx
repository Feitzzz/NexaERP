    ...
    return (
        <>
            ...
            <div className="nexa-page">
                <PageHeader
                    title="Products"
                    description="Manage the products and services available to customers."
                >
                    <Button asChild>
                ...
                <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    ...
                    <StatCard
                        ...
                        detail="Available for invoicing"
                        icon={CircleCheck}
                        tone="success"
                    />
                    <StatCard
                        label="Services"
                        value={summary.services.toLocaleString()}
                        detail="Non-inventory items"
                        icon={Wrench}
                    />
                    <StatCard
                        label="Low stock"
                        ...
                        icon={Package}
                        tone={summary.low_stock ? 'warning' : 'default'}
                    />
                </div>

                <form
                    onSubmit={submit}
                    className="nexa-card grid gap-3 p-3 md:grid-cols-2 xl:grid-cols-[minmax(220px,1.5fr)_repeat(4,minmax(130px,1fr))_auto]"
                >
                    ...
                    <Choice
                        value={taxCategoryId}
                        set={setTaxCategoryId}
                        all="All tax categories"
                ...
                <DataPanel
                    ...
                    description="Pricing, tax and inventory configuration"
                            ...
                            <tbody>
                                {!products.data.length && (
                                    <EmptyTable
                                        ...
                                        description={
                                            hasFilters
                                                ? 'Adjust the filters to find a different product or service.'
                                                : 'Add the first product or service your business sells.'
                                        }
                                        href={
                                            !hasFilters
                                                ? '/products/create'
                                        ...
                                        >
                                            ...
                                            <Td>
                                                {product.track_inventory ? (
                                                    <>
                                                        <span
                                                            className={`block font-medium ${low ? 'text-amber-600' : ''}`}
                                                        >
                                                            {Number(
...
function Choice({ value, set, all, options, extra = null }) {
    return (
