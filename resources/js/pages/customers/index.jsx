    ...
    return (
        <>
            ...
            <div className="nexa-page">
                <PageHeader
                    title="Customers"
                    description="Manage customer records, contact details and account activity."
                >
                    <Button asChild>
                ...
                <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    ...
                    <StatCard
                        ...
                        value={summary.businesses.toLocaleString()}
                ...
                <form
                    onSubmit={submit}
                    className="nexa-card flex flex-col gap-3 p-3 sm:flex-row sm:items-center"
                >
                    <div className="relative max-w-xl flex-1">
                        ...
                        <Input
                            ...
                            placeholder="Search by name, code, TIN, email or phone…"
                        />
                    </div>
                    {filters.search && (
                ...
                <DataPanel
                    ...
                    description="A complete view of customers connected to this business"
                            ...
                            <tbody>
                                {!customers.data.length && (
                                    <EmptyTable
                                        ...
                                        description={
                                            filters.search
                                                ? 'Try a different name, code or contact detail.'
