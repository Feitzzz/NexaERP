    ...
    return (
        <>
            ...
            <div className="nexa-page">
                <PageHeader
                    title="Taxes"
                    description="Review tax classifications, treatments and currently effective rates."
                />
                <div className="flex gap-3 rounded-xl border border-sky-200 bg-sky-50 p-4 text-sky-800 dark:border-sky-900 dark:bg-sky-950/35 dark:text-sky-300">
                    <Info className="mt-0.5 size-4 shrink-0" />
                    <div>
                        <p className="text-sm font-medium">Tax configuration</p>
                        <p className="mt-1 text-xs leading-5 opacity-80">
                            These categories are used during authoritative
                            invoice calculations. External compliance
                ...
                <DataPanel
                    ...
                    description={`${active} active of ${taxCategories.length} configured`}
                            ...
                            <tbody>
                                {!taxCategories.length && (
                                    <EmptyTable
                                        colSpan={5}
                                        icon={ReceiptText}
                                        title="No tax categories configured"
                                        description="Tax categories will appear here when they are available."
                                    />
                                )}
