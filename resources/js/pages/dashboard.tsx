        ...
        <>
            ...
            <div className="nexa-page">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                            A snapshot of your business performance and recent
                            activity.
                        </p>
                    </div>
                    <Button asChild>
                ...
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                    {cards.map(
                        ({ label, value, note, icon: Icon, direction }) => (
                            <div key={label} className="nexa-card p-5">
                                ...
                                <p
                                    className={`mt-1.5 flex items-center gap-1 text-xs ${direction === 'down' ? 'text-rose-500' : direction === 'up' ? 'text-emerald-600' : 'text-muted-foreground'}`}
                                >
                                    {direction === 'up' && (
                ...
                <div className="grid items-start gap-5 xl:grid-cols-[minmax(0,2fr)_minmax(310px,1fr)]">
                    <section className="nexa-card">
                        <CardHeader
                            ...
                            description="Latest activity across your invoices"
                            href="/invoices"
                        />
                        {recentInvoices.length ? (
                            ...
                            <Empty
                                ...
                                copy="Create your first invoice to start tracking revenue and payments."
                    ...
                    <section className="nexa-card">
                        ...
                        <div className="divide-y">
                            <QuickAction
                                ...
                                copy="Draft a new invoice"
                                icon={FilePlus2}
                                href="/invoices/create"
                            />
                            <QuickAction
                                title="Add customer"
                                copy="Register a new customer"
                                icon={Users}
                                href="/customers/create"
                            />
                            <QuickAction
                                title="Add product"
                                copy="Add to your catalogue"
                                icon={Package}
                                href="/products/create"
                            />
                            <QuickAction
                                title="Adjust stock"
                                copy="Record a stock movement"
                                icon={Boxes}
                ...
                <div className="grid items-start gap-5 xl:grid-cols-[minmax(0,2fr)_minmax(310px,1fr)]">
                        ...
                        {lowStockItems.length ? (
                            <div className="divide-y px-5">
                                {lowStockItems.map((item) => (
                                    ...
                                    >
                                        <span className="flex size-9 items-center justify-center rounded-lg border bg-muted/25">
                            ...
                            <div className="flex min-h-28 items-center justify-center px-6 py-8 text-sm text-muted-foreground">
                    ...
                    <section className="nexa-card">
                        <CardHeader
                            ...
                            description="What's happening across your business"
                        />
                        {activity.length ? (
...
function QuickAction({
    ...
    return (
        <Link
            href={href}
            className="group flex items-center gap-3 px-5 py-3.5 hover:bg-muted/30"
        >
...
function ActivityItem({ item, last }: { item: Activity; last: boolean }) {
    ...
    return (
        <div className="relative flex gap-3 py-3">
            {!last && (
                <span className="absolute top-10 bottom-[-12px] left-[17px] w-px bg-border" />
            )}
            <span className="z-10 flex size-9 shrink-0 items-center justify-center rounded-full border bg-background">
                <Icon className="size-4 text-muted-foreground" />
            </span>
