...
export default function Index({ adjustments }) {
    const post = (item) =>
        confirm('Once posted, this adjustment cannot be edited. Continue?') &&
        router.post(`/inventory-adjustments/${item.id}/post`);
    const destroy = (item) =>
        confirm('Delete this draft adjustment?') &&
        router.delete(`/inventory-adjustments/${item.id}`);
    return (
        <>
            ...
            <div className="nexa-page">
                <PageHeader
                    ...
                    description="Prepare and post auditable changes to warehouse quantities."
                >
                    <Button asChild>
                ...
                <DataPanel
                    ...
                    description="Draft and posted inventory changes"
                            ...
                            <tbody>
                                {!adjustments.data.length && (
                                    <EmptyTable
                                        ...
                                        description="Create an opening balance or manual adjustment to change inventory."
